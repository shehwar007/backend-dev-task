    ...
    return {
                ...
                children: [{
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            onLoad: function() {
                                var a =
                                    this.getDialog().getContentElement("info", "widthType").getElement(),
                        ...
                        children: [{
                            ...
                            onLoad: function() {
                                var a = this.getDialog().getContentElement("info", "htmlHeightType").getElement(),
                                    b = this.getInputElement(),
                                    c = b.getAttribute("aria-labelledby");
                                this.getDialog().getContentElement("info", "height").isVisible() && (a.setHtml("\x3cbr /\x3e" + h.widthPx), a.setStyle("display", "block"), this.getDialog().getContentElement("info", "hiddenSpacer").getElement().setStyle("display", "block"));
                                b.setAttribute("aria-labelledby", [c, a.$.id].join(" "))
                            },
                            setup: d(function(a) {
                        ...
                        setup: d(function(a) { var b = a.getAttribute("noWrap"); if ("nowrap" == a.getStyle("white-space") || b) return "no" }),
                        commit: function(a) {
                    ...
                    children: [{
                        ...
                        setup: d(function(a) { if ((a = parseInt(a.getAttribute("colSpan"), 10)) && 1 != a) return a }),
                        commit: function(a) {
                            var b = parseInt(this.getValue(), 10);
                        ...
                        children: [{
                            ...
                            commit: function(a) {
                                this.getValue() ? a.setStyle("background-color",
                                    this.getValue()) : a.removeStyle("background-color");
        ...
        onLoad: function() {
            ...
            this.foreach(function(b) {
                b.setup &&
                    b.commit && (b.setup = CKEDITOR.tools.override(b.setup, function(c) {
                        return function() {
