...
(function() {
    CKEDITOR.dialog.add("link", function(c) {
        ...
        var n = CKEDITOR.plugins.link,
            ...
            e = function(a) { a.advanced && this.setValue(a.advanced[this.id] || "") },
            k = function(a) {
                a.target || (a.target = {});
            ...
            contents: [{
                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        children: [{ type: "hbox", children: [{ type: "checkbox", id: "resizable", label: b.popupResizable, setup: l, commit: k }, { type: "checkbox", id: "status", label: b.popupStatusBar, setup: l, commit: k }] }, { type: "hbox", children: [{ type: "checkbox", id: "location", label: b.popupLocationBar, setup: l, commit: k }, { type: "checkbox", id: "toolbar", label: b.popupToolbar, setup: l, commit: k }] }, {
                            type: "hbox",
                            children: [{
                                type: "checkbox",
                                id: "menubar",
                            ...
                            type: "hbox",
                            children: [{ type: "text", widths: ["50%", "50%"], labelLayout: "horizontal", label: g.width, id: "width", setup: l, commit: k }, {
                                type: "text",
                ...
                elements: [{
                    ...
                    children: [{
                        type: "hbox",
                        widths: ["45%", "35%", "20%"],
                        children: [{ type: "text", id: "advId", requiredContent: "a[id]", label: b.id, setup: e, commit: m }, {
                            type: "select",
                            id: "advLangDir",
