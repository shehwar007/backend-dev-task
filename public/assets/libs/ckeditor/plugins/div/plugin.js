            ...
            if (!a.blockless) {
                ...
                a.addCommand("creatediv",
                    new CKEDITOR.dialogCommand("creatediv", {
                        ...
                        refresh: function(a, c) { this.setState("div" in (a.config.div_wrapTable ? c.root : c.blockLimit).getDtd() ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED) }
                    }));
