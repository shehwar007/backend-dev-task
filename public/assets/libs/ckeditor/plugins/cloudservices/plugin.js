        ...
        beforeInit: function(a) {
            var c = a.config.cloudServices_tokenUrl,
                e = {
                    ...
                    refreshToken: function() { CKEDITOR.ajax.load(c, function(b) { b && (e.token = b) }) },
                    init: function() {
                        this.refreshToken();
            ...
            a.on("fileUploadResponse", function(a) {
                var c = a.data.fileLoader,
                    d = c.xhr,
                    e;
                if (c instanceof CKEDITOR.plugins.cloudservices.cloudServicesLoader) { a.stop(); try { e = JSON.parse(d.responseText), a.data.response = e } catch (g) { CKEDITOR.warn("filetools-response-error", { responseText: d.responseText }) } }
            })
        }
    });
