    ...
    function q(a, f) {
        ...
        return {
            ...
            onOk: function() {
                ...
                if (this._.selectedElement) try { e.selectBookmarks(d) } catch (p) {} else a.insertElement(b), setTimeout(function() {
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            setup: function(e) {
                                ...
                                for (var b = 0; b < e.$.rows.length; b++) { var c = e.$.rows[b].cells[0]; if (c && "th" != c.nodeName.toLowerCase()) { a.hasColumnHeaders = !1; break } }
