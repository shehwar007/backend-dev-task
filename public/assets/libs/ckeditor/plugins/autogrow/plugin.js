...
(function() {
    function h(a) {
        ...
        function g() {
            ...
            b = Math.max(b, r);
            b = Math.min(b, p);
            b != d && l != b && (b = a.fire("autoGrow", { currentHeight: d, newHeight: b }).newHeight, a.resize(a.container.getStyle("width"), b, !0), l = b);
        ...
        var t = { contentDom: 1, key: 1, selectionChange: 1, insertElement: 1, mode: 1 },
            q;
        for (q in t) a.on(q, function(d) { "wysiwyg" == d.editor.mode && setTimeout(function() { var b = a.getCommand("maximize");!a.window || b && b.state == CKEDITOR.TRISTATE_ON ? l = null : (g(), k || g()) }, 100) });
