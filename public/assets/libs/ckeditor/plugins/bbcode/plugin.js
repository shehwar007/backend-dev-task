...
(function() {
    ...
    var l = {
        ...
        m = { strong: "b", em: "i", u: "u", li: "*", ul: "list", ol: "list", code: "code", a: "link", img: "img", blockquote: "quote" },
        ...
        r = [],
        t;
    for (t in q) B[q[t]] = t, r.push(q[t].replace(/\(|\)|\:|\/|\*|\-|\|/g, function(a) { return "\\" + a }));
    var r = new RegExp(r.join("|"), "g"),
        D = function() {
            ...
            return function(c) { return c.replace(a, function(a, c) { return b[c] }) }
        }();
    ...
    CKEDITOR.BBCodeParser.prototype = {
        parse: function(a) {
            for (var b, c, h = 0; b = this._.bbcPartsRegex.exec(a);)
                if (c = b.index, c > h && (h = a.substring(h, c), this.onText(h, 1)), h = this._.bbcPartsRegex.lastIndex, (c = (b[1] || b[3] || "").toLowerCase()) && !l[c]) this.onText(b[0]);
                else if (b[1]) {
                var f = l[c],
                    k = {},
                    g = {};
                if (b = b[2])
                    if ("list" == c && (isNaN(b) ? /^[a-z]+$/.test(b) ? b = "lower-alpha" : /^[A-Z]+$/.test(b) && (b = "upper-alpha") : b = "decimal"), y[c]) {
                        "size" == c && (b += "%");
                        g[y[c]] = b;
                        b = k;
                        var e = "",
    ...
    CKEDITOR.htmlParser.fragment.fromBBCode = function(a) {
        ...
        f.onTagClose = function(a) {
            for (var f = g.length - 1; 0 <= f; f--)
                if (a == g[f].name) { g.splice(f, 1); return }
    ...
    var v = new(CKEDITOR.tools.createClass({
        ...
        proto: {
            ...
            getRule: function(a, b) { return this._.rules[a] && this._.rules[a][b] },
            openTag: function(a) {
            ...
            attribute: function(a, b) { "option" == a && this.write("\x3d", b) },
        ...
        init: function(a) {
            ...
            h.addRules({
                elements: {
                    ...
                    span: function(a) { var b; if (b = a.attributes.bbcode) "img" == b ? (a.name = "img", a.attributes.src = a.children[0].value, a.children = []) : "email" == b && (a.name = "a", a.attributes.href = "mailto:" + a.children[0].value), delete a.attributes.bbcode },
                    ol: function(a) {
            ...
            if (a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE) a.once("contentDom", function() { a.on("setData", b) });
            else a.on("setData", b)
        },
